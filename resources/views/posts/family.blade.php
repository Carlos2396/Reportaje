...
<section class="s-content s-content--narrow s-content--no-padding-bottom">
    <article class="row format-standard">
        ...
        <div class="col-full s-content__main">
            ...
            <p>Los adultos mayores son visibles en los susurros sabios, en las oraciones más sinceras, en su andar pausado los domingos por el centro de la ciudad. De hecho, de acuerdo con el <strong>INEGI</strong>, para 2017, en tres de cada diez hogares mexicanos había, por lo menos, un adulto mayor.</p>
            ...
            <p>Cuando cumplió 22 años decidió formar su propia familia con Martha, a quien conocía desde la infancia. Tuvieron nueve hijos, 17 nietos y siete bisnietos. Ahora, a sus 89 años vive con su hija Silvia, y Pablito, su nieto. Sin embargo, a pesar de estar acompañado, se siente solo.</p>
            ...
            <p>En 2015, apareció un dolor punzante en la espalda baja que día con día se hizo más fuerte. El diagnóstico no era bueno, su médula espinal se estaba comprimiendo y era necesaria una operación. Todo resultó bien y a pesar de que la recuperación fue tardada, meses después ya estaba de nuevo practicando una de sus pasiones: el alpinismo.</p>
        ...
        <div class="col-full s-content__main">
            <p>Estas reacciones sobre lo que los adultos mayores dicen, visibilizan, como explica la <strong>psicogerontóloga María Fernanda Herrera Delgado</strong>, una desvalorización. <strong>Los jóvenes suelen creer que el adulto mayor no sabe, no entiende, no puede o que está desfasado porque son otros tiempos; situación que puede inducir al adulto mayor a dejar de comunicarse.</strong></p>
            <p>En este sentido, la repetición de historias es común y proviene del gusto por platicar de su época, es decir, de lo que ya pasó. La <strong>psicogerontóloga Adriana Ramayo Romero</strong> añade que esto puede generar como joven desinterés, hartazgo e, incluso, expresiones como “¡Ay esa historia ya me la contaste diez veces!”, pero en términos psicológicos, la repetición de historias pasadas por parte del adulto mayor puede deberse a dos causas: <strong>emocionales o fisiológicas</strong>.</p>
            <p>Sobre la primera, señala que remite a la <strong>añoranza</strong>, la cual se manifiesta como consuelo por estar mucho tiempo en casa solos y con actividades monótonas; mientras que sobre la segunda, se podría deber a la <strong>demencia</strong>, común en edades avanzadas por deterioro cognitivo; que genera olvido en su memoria reciente y provoca que recordar lo que hicieron hace 20, 30 o 40 años, sea más fácil.</p>
            <p>La <strong>OMS</strong> señala que el tener más para recordar puede ayudar a las personas mayores a tomar mejores decisiones. Citando un <a href="https://academic.oup.com/psychsocgerontology/article/58/1/P3/566180">estudio realizado por la Universidad de Oxford</a>, indica que sensibilizar a los adultos mayores con un recuerdo positivo hacía que identificaran estrategias de memorización eficaces, es decir, cuando estos comparten sus mejores experiencias, están ejercitando su memoria y su mente.</p>
            <p>Ellos antes de ser adultos mayores, son personas, individuos que buscan <strong>interacciones significativas</strong>, conversaciones donde sus palabras sean valiosas, motivación en lo que escuchan y convivencia donde se sientan en igualdad con sus interlocutores. Alguna vez trabajaron, tuvieron que hacerse cargo de hijos, de cuentas y del hogar; <strong>pueden entender lo que los jóvenes viven y además, tienen la capacidad de aportar conocimientos y experiencias.</strong></p> 
            ...
            <p><strong>La interacción es indispensable para llegar al bienestar</strong>. Como seres sociales se necesita del otro, pero no del otro igual, sino de todos los otros. Es decir, es necesario convivir con personas distintas; que tengan visiones y experiencias que enriquezcan lo que ya se conoce y enseñen lo desconocido; porque es en lo extraño donde se encuentra lo que hace falta.</p>
            <p>Los adultos mayores parecieran estar alejados del mundo más joven, porque no van tan rápido, porque no siguen pantallas líquidas, ni son tan flexibles en sus ideales, “Creen que uno ya no puede, que uno ya no debe; le hacen sentir a uno que no tiene carácter” añade don Rafa con voz conflictuada. Este problema tiene lugar porque como jóvenes muchas veces no se comprende que <strong>en la divergencia está la posibilidad de construir puentes y puntos de encuentro intergeneracionales.</strong></p> 
            ...
            <p class="lead">El acompañamiento a un adulto mayor, no se agota en el acompañamiento físico y estar “veinticuatro-siete” con ellos, sino a tener relaciones comunicativas basadas en disposición, apertura, calidad y resonancia. Es tenerle presente y ser presencia.</p>
