...
<section class="s-content s-content--narrow s-content--no-padding-bottom">
    <article class="row format-standard">
        ...
        <div class="col-full s-content__main">
            ...
            <p>A nivel socioeconómico es innegable que las disparidades de ingresos representan riesgos, así aseveran los sociólogos Fernando Bruno y Jesús Acevedo han demostrado en un artículo que el envejecimiento de la población en el país  ‘se lleva a cabo en un contexto caracterizado por un alto índice de pobreza, una amplia desigualdad social y económica producto de una redistribución regresiva del ingreso, y en el plano del mercado de trabajo, con una clara deficiencia en la creación de empleos de calidad y regulados'.</p>
            ...
            <p>A nivel familiar <strong>Francisco Gutiérrez, director del Centro de Evaluación e Investigación Psicológica de la Universidad de Guadalajara (UdeG)</strong> explica en el reportaje <a href="https://magis.iteso.mx/anteriores/016/016_indivisa_sociedad.htm">México envejece "cuando tu vas, yo ya vengo"</a> que:</p>
